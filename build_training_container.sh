...
image_name=gcr.io/$PROJECT_ID/merlin/merlin-training # Specify the image name here
image_tag=0.5.1

full_image_name=${image_name}:${image_tag}

docker build --build-arg gcloud_key=$GCLOUD_KEY  -f Dockerfile.train -t $full_image_name .
