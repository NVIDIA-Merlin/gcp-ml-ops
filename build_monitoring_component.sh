...
image_name=gcr.io/$PROJECT_ID/monitoring # Specify the image name here
image_tag=0.5.1

full_image_name=${image_name}:${image_tag}

docker build --build-arg gcloud_key=$GCLOUD_KEY --build-arg project_id=$PROJECT_ID -f Dockerfile.monitoring -t $full_image_name  .
